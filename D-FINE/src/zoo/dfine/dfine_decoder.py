    ...
    def _build_input_proj_layer(self, feat_channels):
        ...
        for in_channels in feat_channels:
            if in_channels == self.hidden_dim:
                ...
                self.input_proj[-1].add_module("conv", nn.Conv2d(in_channels, self.hidden_dim, 1, bias=False))
                self.input_proj[-1].add_module("norm", nn.BatchNorm2d(self.hidden_dim))
