...
if "0.15.2" in importlib.metadata.version("torchvision"):
    ...
    from torchvision.transforms.v2 import SanitizeBoundingBoxes  # noqa
    from torchvision.tv_tensors import BoundingBoxes, BoundingBoxFormat, Image, Mask, Video  # noqa
...
def convert_to_tv_tensor(tensor: Tensor, key: str, box_format="xyxy", spatial_size=None) -> Optional[Tensor]:
    """
    Args:
